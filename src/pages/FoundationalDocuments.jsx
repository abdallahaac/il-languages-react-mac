...
const FoundationalDocuments = ({ onNavigate }) => {
	...
	const trcCardData = [
		...
		},
		{
			...
			back: `
				<p>We call upon the federal government to enact an Aboriginal Languages Act that incorporates the following principles:</p><ol><li style="font-size:17px">Aboriginal languages are a fundamental and valued element of Canadian culture and society, and there is an urgency to preserve them.</li><li style="font-size:17px">Aboriginal language rights are reinforced by the Treaties.</li><li style="font-size:17px">The federal government has a responsibility to provide sufficient funds for Aboriginal-language revitalization and preservation.</li><li style="font-size:17px">The preservation, revitalization, and strengthening of Aboriginal languages and cultures are best managed by Aboriginal people and communities.</li><li style="font-size:17px">Funding for Aboriginal language initiatives must reflect the diversity of Aboriginal languages.</li></ol>
