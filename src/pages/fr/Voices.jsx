	...
	return (
		<div className="intro-wrapper">
			...
			<section className="acknowledge">
				<h2>Voix autochtones</h2>
				<p>
					Les enregistrements suivants présentent les voix de fonctionnaires
					autochtones à travers le pays qui ont généreusement partagé leur temps
					et leurs compétences linguistiques avec nous. Ces extraits vous
					permettront de mieux apprécier la richesse du patrimoine linguistique
					et la diversité culturelle qui enrichissent notre pays.
				</p>
			</section>
			<section className="acknowledge">
				<h2>Remerciements</h2>
				<p>
					Merci du fond du cœur aux fonctionnaires autochtones qui ont consacré
					du temps à ce projet et qui nous ont donné le privilège d’entendre et
					d’apprécier la richesse de leurs langues par ces enregistrements
					audio.
				</p>
			</section>
			...
			<section className="instructions" aria-labelledby="instr-heading">
				<h3 id="instr-heading">
					Instructions pour naviguer dans les interactions numérotées avec des
					clips audio
				</h3>
				<ol className="graph-ol">
					<li>
						<strong>Identifier l'icône :</strong> Repérez les icônes numérotées
						sur l'écran. Ces icônes sont interactives et déclencheront un clip
						audio lorsqu'on clique dessus.
					</li>
					<li>
						<strong>Cliquez sur une icône :</strong> Sélectionnez une icône
						numérotée en cliquant dessus. Cette action lancera le clip audio
						associé.
					</li>
					<li>
						<strong>Écoutez l'audio :</strong> Après avoir cliqué, un clip audio
						se lancera automatiquement. Assurez-vous que le volume de votre
						appareil est monté et que les haut-parleurs ou les écouteurs sont
						correctement connectés.
					</li>
					<li>
						<strong>Passez à l'icône suivante :</strong> Après avoir écouté
						l'audio, cliquez sur l'icône numérotée suivante pour continuer
						l'interaction.
					</li>
					<li>
						<strong>Terminez l'interaction :</strong> Continuez à cliquer sur
						toutes les icônes numérotées jusqu'à ce que vous ayez terminé
			...
			<section className="audio-block" aria-labelledby="audio-heading">
				<h3 id="audio-heading" className="sr-only">
					Interaction avec les extraits audio
				</h3>
				...
				<div className="audio-progress" role="status" aria-live="polite">
					{visitedClips.size > 0 && (
						<p>
							{remainingClips > 0
								? `Vous avez écouté ${visitedClips.size} des ${clips.length} extraits audio.`
								: "Excellent! Vous avez exploré tous les extraits audio."}
						</p>
					)}
				</div>
